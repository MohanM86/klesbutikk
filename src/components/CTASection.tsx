    ...
    <section className="bg-accent rounded-2xl p-10 md:p-16 text-center relative overflow-hidden">
      ...
      <div className="relative">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
          <Link href={primaryHref} className="inline-flex items-center justify-center px-8 py-4 bg-accent text-white font-body font-bold text-sm rounded-xl hover:bg-accent-hover transition-all shadow-lg">
            {primaryCta}
          </Link>
