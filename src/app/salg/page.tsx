      ...
      <section className="bg-surface-alt">
        <div className="max-w-8xl mx-auto section-padding pt-6 pb-10 md:pt-10">
          ...
          <div className="mt-4 max-w-2xl">
            <p className="font-body text-[11px] font-bold text-accent uppercase tracking-[0.08em] mb-3">Salg og tilbud</p>
        ...
        <div className="max-w-8xl mx-auto section-padding py-12 md:py-16">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {SALG_CATEGORIES.map((cat) => (
              <div key={cat.slug} className="bg-cream border border-border rounded-lg p-6 hover:border-accent hover:shadow-lg transition-all duration-200 cursor-pointer">
