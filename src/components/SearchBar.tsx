...
const TYPING = ['Holzweiler i Oslo', 'Vintage butikker i Bergen', 'Barneklaer Trondheim', 'Filippa K Stavanger', 'Nike i Oslo'];
    ...
    return (
      <div ref={ref} className="relative w-full max-w-xl">
        <div className="relative flex items-center bg-surface-alt border border-border focus-within:border-black rounded-full transition-colors">
          ...
          <input type="text" value={query} onChange={(e) => setQuery(e.target.value)} placeholder="Sok etter by, merke eller butikk..."
    ...
    <div ref={ref} className="relative w-full max-w-[540px] mx-auto">
      <div className="relative">
        ...
        <input ref={inputRef} type="text" value={query}
          ...
          placeholder={placeholder || 'Sok etter by, merke eller butikk...'}
