...
export default function BrandPage({ params }: PageProps) {
  ...
  const brandFaqs = brand.storeCount > 0 ? [
    ...
    {
      question: `Hvor kan jeg kjøpe ${brand.name} i Norge?`,
      answer: `Vi har foreløpig ikke registrert dedikerte ${brand.name}-butikker i Norge i vår database. ${brand.name} kan likevel finnes hos multimerke-forhandlere og kjøpesentre. Sjekk butikkoversikten vår for å finne mulige forhandlere.`,
    },
    {
          ...
          <p className="font-body text-base text-muted max-w-lg">
            {brand.storeCount > 0 ? (
              ...
              <>
                ...
                {' '}{brand.name}-butikker i vår database, men merket kan finnes hos
