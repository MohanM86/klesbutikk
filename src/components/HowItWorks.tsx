        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 md:gap-6">
          ...
          >
            ...
            <div className="bg-surface border border-border rounded-2xl p-4 mx-auto max-w-[220px] mb-3">
              <div className="flex items-center gap-2 bg-white border-2 border-accent rounded-xl px-3 py-2.5">
              ...
              <div className="flex flex-wrap gap-1.5 mt-2">
                {['Bergen', 'Trondheim', 'Stavanger'].map((c) => (
                  <span key={c} className="font-body text-[10px] bg-white border border-border px-2 py-0.5 rounded-lg text-muted">{c}</span>
                ))}
              </div>
            </div>
            ...
            <div className="bg-surface border border-border rounded-2xl p-4 mx-auto max-w-[220px] mb-3">
              ...
              <div className="flex gap-1 mb-1.5">
                {['Holzweiler', 'Ganni'].map((m) => (
                  <span key={m} className="font-body text-[9px] bg-white border border-border px-1.5 py-0.5 rounded text-muted">{m}</span>
                ))}
          ...
          >
            ...
            <div className="bg-surface border border-border rounded-2xl p-4 mx-auto max-w-[220px] mb-3">
              <div className="flex gap-2 mb-2">
                ...
                <div className="flex-1 bg-white border border-border rounded-xl py-2.5 text-center">
                  <div className="flex items-center justify-center gap-1.5">
