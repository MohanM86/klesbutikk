      ...
      <div className="max-w-8xl mx-auto section-padding py-14 md:py-16">
        ...
        <div className="border-t border-white/10 pt-6 flex flex-col sm:flex-row justify-between items-center gap-3">
          ...
          <div className="flex items-center gap-4">
            <Link href="/personvern" className="font-body text-xs text-white/30 hover:text-accent transition-colors">Personvern</Link>
            <Link href="/vilkar" className="font-body text-xs text-white/30 hover:text-accent transition-colors">Vilkår</Link>
