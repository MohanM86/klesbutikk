        ...
        <div className="bg-white border border-border rounded-lg shadow-lg p-4 relative">
          ...
          {state === 'idle' && (
            <div className="flex items-center gap-3">
              ...
              <div className="flex-1 min-w-0">
                <p className="font-body text-sm font-bold text-black">Finn klesbutikker naer deg</p>
                <p className="font-body text-xs text-muted">Vi finner din naermeste by</p>
              </div>
          ...
          {(state === 'asking' || state === 'searching') && (
            <div className="flex items-center gap-3">
              ...
              <div><p className="font-body text-sm font-bold text-black">{state === 'asking' ? 'Venter pa tilgang...' : 'Soker...'}</p></div>
            </div>
          )}
          {state === 'found' && city && (
            <div className="flex items-center gap-3">
