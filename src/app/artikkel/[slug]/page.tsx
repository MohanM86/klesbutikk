...
const BLOG_POSTS: BlogPost[] = [
  {
    ...
    content: [
      ...
      'I denne guiden tar vi deg gjennom de beste klesbutikkene i Norge, sortert etter by og kategori. Vi har brukt data fra Brønnøysundregistrene og vår egen database med over 1 500 butikker for å gi deg den mest komplette oversikten.',
      ...
      'For å finne klesbutikker i din by, bruk søkefunksjonen på Klesbutikk.no. Vi oppdaterer databasen jevnlig med data fra Brønnøysundregistrene for å sikre at du alltid finner oppdatert informasjon.',
    ],
  },
  {
