...
const HOME_FAQS = [
  { question: 'Hva er de beste klesbutikkene i Norge?', answer: 'Norge har over 1 500 registrerte klesbutikker fra Lindesnes til Nordkapp. De mest populaere finner du i Oslo, Bergen, Trondheim og Stavanger. Pa Klesbutikk.no kan du utforske alle registrerte klesbutikker i landet og finne favorittene i din by.' },
  { question: 'Hvordan finner jeg klesbutikker naer meg?', answer: 'Bruk sokefeltet overst pa siden for a soke etter din by, et merke eller en butikk. Du kan ogsa bla gjennom bysider, fylkesider eller kategorier for a finne klesbutikker i ditt naeromrade.' },
  { question: 'Hvilke klesmerker kan jeg finne pa Klesbutikk.no?', answer: 'Vi har kartlagt over 480 klesmerker, alt fra norske favoritter som Holzweiler, Stine Goya og Filippa K til internasjonale stormerker som Nike, Gucci og Zara. Du kan soke pa merke og se hvilke butikker som forer det.' },
  { question: 'Hvor finner jeg treningsklaer i Norge?', answer: 'Klesbutikk.no har registrert over 200 butikker som forer treningsklaer i Norge. Du finner alt fra treningsklaer for dame og herre til spesialiserte butikker for loping, yoga og utendorstrening.' },
  { question: 'Finnes det gode norske klesbutikker pa nett?', answer: 'Ja, mange norske klesbutikker tilbyr ogsa netthandel. Vi har samlet en egen oversikt over norske nettbutikker for klaer der du kan handle dameklaer, herreklaer, barneklaer og treningsklaer pa nett fra norske aktorer.' },
  { question: 'Hva er de beste klesbutikkene i Oslo?', answer: 'Oslo har over 253 registrerte klesbutikker og er Norges mest varierte handleby for mote. Populaere handlestrok inkluderer Bogstadveien, Hegdehaugsveien, Grunerlokka og Aker Brygge.' },
  { question: 'Hvor mange klesbutikker finnes det i Norge?', answer: 'Klesbutikk.no har registrert over 1 566 klesbutikker fordelt pa 357 kommuner og 15 fylker. Oslo har det klart storste utvalget med over 253 butikker, etterfulgt av Bergen, Trondheim og Stavanger.' },
  { question: 'Hva koster det a bruke Klesbutikk.no?', answer: 'Klesbutikk.no er helt gratis a bruke. Du kan soke, utforske og finne klesbutikker uten a betale noe som helst.' },
  { question: 'Hvordan skiller Klesbutikk.no seg fra andre butikkoversikter?', answer: 'Klesbutikk.no er spesialisert utelukkende pa klesbutikker i Norge. I motsetning til generelle bedriftsoversikter har vi detaljert informasjon om merker, kategorier og spesialisering for hver butikk. Vi dekker 357 kommuner med naesten 8 000 unike sider.' },
];

const CATS = [
  { name: 'Dameklaer', slug: 'dameklar', desc: 'Kjoler, topper, jakker og alt for henne', count: 342 },
  { name: 'Herreklaer', slug: 'herreklar', desc: 'Dresser, skjorter, bukser og mer', count: 289 },
  { name: 'Sportsklaer', slug: 'sport', desc: 'Treningsklaer, outdoor og friluftsutstyr', count: 201 },
  { name: 'Barneklaer', slug: 'barneklar', desc: 'Klaer for barn og baby i alle aldre', count: 156 },
  { name: 'Designer', slug: 'designer', desc: 'Eksklusive merker og luksusmote', count: 87 },
  { name: 'Vintage', slug: 'vintage', desc: 'Secondhand, retro og baerekraftig mote', count: 64 },
];
    ...
    <>
      ...
      <section className="bg-black text-white py-16 md:py-20 text-center relative overflow-hidden">
        <div className="max-w-2xl mx-auto section-padding relative z-10">
          <p className="font-body text-[11px] font-bold text-accent uppercase tracking-[0.1em] mb-5">Norges storste klesbutikkoversikt</p>
          ...
          <p className="font-body text-[15px] text-white/60 leading-relaxed mb-8 max-w-md mx-auto">
            Sok blant butikker, merker og byer fra Lindesnes til Nordkapp. Helt gratis.
          </p>
      ...
      <section className="py-12 md:py-16">
        <div className="max-w-8xl mx-auto section-padding">
          <div className="flex items-baseline justify-between mb-6">
            <h2 className="font-body text-display-sm md:text-display font-extrabold text-black">Populaere kommuner</h2>
          ...
          <FadeInSection>
            <div className="max-w-3xl">
              ...
              <div className="font-body text-[14px] text-slate leading-relaxed space-y-4">
                <p>Norge har et rikt og variert utvalg av klesbutikker fra de storste byene til de minste tettstedene. Enten du leter etter en klesbutikk i naerheten med eksklusive designermerker eller en rimelig nettbutikk med bredt utvalg, finnes det norske klesbutikker for enhver smak, stil og lommebok. Klesbutikk.no har samlet alle disse pa ett sted og gjort dem sokbare etter by, fylke, merke og kategori.</p>
                <p>Med over {stats.totalStores.toLocaleString('nb-NO')} registrerte klesbutikker fordelt pa 357 kommuner og alle 15 fylker er Klesbutikk.no den mest komplette oversikten over klesbutikker i Norge.</p>
              </div>
            </div>
          </FadeInSection>
        </div>
      ...
      <section className="bg-surface-alt py-12 md:py-16">
        <div className="max-w-8xl mx-auto section-padding">
          <h2 className="font-body text-display-sm md:text-display font-extrabold text-black mb-8">Klesbutikker i Norges storste byer</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {[
              { name: 'Klesbutikker i Oslo', slug: 'oslo', n: 253, text: 'Oslo er Norges ubestridte motehovedstad. Leter du etter klesbutikk i Oslo finner du alt fra luksusmerker pa Aker Brygge til vintage i Grunerlokka. Bogstadveien og Hegdehaugsveien er blant de mest populaere handlegatene.' },
              { name: 'Klesbutikker i Bergen', slug: 'bergen', n: 39, text: 'Klesbutikker i Bergen sentrum finner du hovedsakelig rundt Torgallmenningen og Strandgaten. Skandinavisk minimalisme moter vestlandsk kreativitet.' },
              { name: 'Klesbutikker i Trondheim', slug: 'trondheim', n: 39, text: 'Klesbutikker i Trondheim sentrum er konsentrert rundt Nordre gate og Thomas Angells gate. Byens store studentmiljo bidrar til et overraskende bredt butikktilbud.' },
              { name: 'Klesbutikker i Stavanger', slug: 'stavanger', n: 39, text: 'Klesbutikker i Stavanger sentrum finner du langs Klubbgata og Kirkegata. Regionen har et sterkt innslag av outdoor og friluftsklaer.' },
            ].map((c) => (
      ...
      <section className="border-t border-border py-12 md:py-16">
        <div className="max-w-8xl mx-auto section-padding">
          <FadeInSection className="max-w-3xl">
            <h2 className="font-body text-display-sm md:text-display font-extrabold text-black mb-5">Klesbutikk pa nett</h2>
            <div className="font-body text-[14px] text-slate leading-relaxed space-y-4">
              <p>I tillegg til fysiske klesbutikker har vi kartlagt norske <Link href="/nettbutikker" className="text-accent font-semibold hover:underline">nettbutikker</Link> som selger klaer. Netthandel med klaer har vokst kraftig, og stadig flere nordmenn handler dameklaer pa nett, treningsklaer pa nett og barneklaer pa nett.</p>
              <p>Fordelene med a handle i en norsk klesbutikk pa nett inkluderer enklere returhandtering, norskspraklig kundeservice og raskere levering.</p>
            </div>
          </FadeInSection>
        </div>
      </section>
